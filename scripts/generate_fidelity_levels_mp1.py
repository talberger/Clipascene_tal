...
def run(clip_conv_layer_weights, test_name):
    exit_code = sp.run(["python", 
...
if __name__ == "__main__":
    ...
    layer_opt_list = [3, 5]
    for l_opt in layer_opt_list:
        args.layer_opt = l_opt
        ...
        P.apply_async(run, (clip_conv_layer_weights,test_name))
    if True:
        P.close()
        print(test_name)
