...
if __name__ == "__main__":
        ...
        logging.info(f'python scripts/run_4_sketches.py --im_name {args.im_name} --layer_opt {args.layer_opt} --divs {args.divs}'
             f' --fg_bg_separation {args.fg_bg_separation} --num_strokes {args.num_strokes}')
        logging.info(f"Total time for 2x2 matrix: [{total_time/60:.2f}] minutes")