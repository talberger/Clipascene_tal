...
This optimization will be conducted without separating the background from the object, which may affect the quality of the sketch. In this case, the runtime will be 10.5 minutes.
