...
Running the full pipeline, which produces a 3x9 matrix (encompassing 3 levels of fidelity and 9 levels of simplicity), can take several hours. For faster results, you have the option of conducting a mini run using two methods:
